IF OBJECT_ID('[articles_dev]', 'U') IS NULL
CREATE TABLE [articles_dev]
(
...
GO
IF OBJECT_ID('[articles_dev]', 'U') IS NULL
ALTER TABLE [articles_dev]
ADD CONSTRAINT [articles_dev_plain_text_as_json]
CHECK (ISJSON([plain_text])=1);
ALTER TABLE [articles_dev]
ADD CONSTRAINT [articles_dev_metadata_as_json]
