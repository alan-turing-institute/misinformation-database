...
DROP INDEX IF EXISTS [publication_datetime_article_url] ON [articles_v5]
DROP INDEX IF EXISTS [recently_inserted_articles_by_site] ON [articles_v5]
GO
...
CREATE INDEX [recently_inserted_articles_by_site] ON [articles_v5] ([site_name], [id] DESC);
GO
